...
public class ContentProviderTimeoutCache
    ...
    private int putValues(String acronym,
        ...
        for (int i = 0; i < longForms.size(); i++) {
        	...
        	//cvs.put(AcronymEntry.COLUMN_LONG_FORM, ae.getLf());
        	//cvs.put(AcronymEntry.COLUMN_FREQUENCY, ae.getFreq());
        	//cvs.put(AcronymEntry.COLUMN_SINCE, ae.getSince());
    ...
    public void removeExpiredAcronyms() {
        ...
        mContext.getContentResolver().delete
        	(AcronymEntry.CONTENT_URI,
        	AcronymEntry.SELECTION_EXPIRATION,
        	selectionArgs);
    }
